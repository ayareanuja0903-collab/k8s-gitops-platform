...
| ----------------------- | ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 🔗 <a href="https://github.com/ayareanuja0903-collab/K8s-GitOps-Platform" rel="noopener noreferrer" style="text-decoration:none; color:#0366d6; font-weight:500;">K8s-GitOps-Platform</a> | Infrastructure & Platform Setup | • Provision Kubernetes cluster using Terraform <br> • Configure nodes using Ansible <br> • Setup ArgoCD, monitoring stack (Prometheus, Grafana, Alertmanager) <br> • Acts as the **foundation layer**        |
