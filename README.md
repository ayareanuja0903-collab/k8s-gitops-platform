...
|<a href="https://github.com/ayareanuja0903-collab/k8s-ansible-config" target="_blank" rel="noopener noreferrer" style="text-decoration:none; color:#0366d6; font-weight:500;">🔗 k8s-ansible-config </a> | Configuration Automation        | • Automates Kubernetes setup using Ansible <br> • Handles Docker/container runtime installation <br> • Initializes master node & joins worker nodes <br> • Ensures consistent environment setup across nodes |
